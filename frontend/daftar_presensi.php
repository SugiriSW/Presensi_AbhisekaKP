                                        ...
                                        <td>
                                            ...
                                            switch ($row['status_kehadiran']) {
                                                case 'hadir':
                                                    ...
                                                    break;
                                                case 'terlambat':
                                                    $badge_class = 'bg-warning text-dark'; // Kuning/Oranye
                                                    break;
                                                case 'izin':
                                                    $badge_class = 'bg-info'; // Biru muda
                                                    break;
                                                case 'cuti':
                                                    $badge_class = 'bg-primary'; // Biru tua
                                                    break;
                                                case 'libur':
                                                ...
                                                case 'sakit':
                                                    ...
                                                    break;
                                                default:
                                                    $badge_class = 'bg-dark'; // Hitam untuk status tidak dikenal
                                            }
                                            ?>
                                            <span class="badge <?= $badge_class ?>"><?= ucfirst($row['status_kehadiran']) ?></span>
                                        </td>
                                        <td>
